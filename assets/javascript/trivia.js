$(document).ready(function(){
	...
	var background = new Audio("assets/audio/background.mp3"); //Ongoing audio file
	var what = new Audio("assets/audio/lose.mp3"); //Audio for incorrect question
	background.play(); //audio background
	background.loop = true; //loop for audio
	var r = 0;
	var guess;
